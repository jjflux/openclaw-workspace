...
**2026-08-27 — receptionist pulled from `/pricing` too** (Jakob: "delete the AI Receptionist under pricing, you can leave it under the case studies"). Removed: the whole CORE PRODUCT section ($295/mo + $2,100/yr rows), the meta description + hero "calls answered" claims, and the STARTER bundle (it was receptionist + Review Automation — without the receptionist it was a single $75 service, not a bundle). **Bundle prices were re-derived, not invented:** every bundle was anchored on the $295 receptionist, so GROWTH went $500 → **$205/mo** (Review Automation $75 + GBP $150 = $225 parts, less the $20 saving) and DONE FOR YOU went $750 → **$305/mo** (parts $75+$150+$125 = $350, less a $45 saving); one-time add-ons unchanged. Jakob should sanity-check those two numbers — they are arithmetic off the page's own list prices, not a pricing decision. Still deliberately untouched: the North Star case study's Lead Lock story (real narrative), and `pricing-internal.html`, which is tracked and **publicly reachable at /pricing-internal** (200) despite being an internal doc — worth noindexing or deleting.
